...
- Fixed: the automatic checks on GitHub now read test counts from colored output. Every check
  run on GitHub failed on this before, even when all tests passed.
