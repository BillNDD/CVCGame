...
/* The splash update controls (SPEC section 7a, owner-approved 2026-08-07).
   They sit in the grown-up strip of the child's first screen, so they take
   the same 450 ms hold as the adult result controls: S6's promise — the
   network is only ever touched by a deliberate adult act — has to survive
   any number of child taps, and "Update now" restarts the app, so it above
   all is never one tap away. */
