...
- Baseline floors: `g13_clips` (756) and `g13_engine_tests` (13).
...
- Baseline floor: `g17_governing_files` (33). It moved from 23 on 2026-08-11, when the
...
- **HISTORY is a ceiling, not a floor.** The only declaration that legitimises a file with
  ...
  read as live.
- Keys: `g23_declared` (34), `g23_facts` (4), `g23_controls` (40), problems capped at 0,
...
- Keys: `g24_files` (212), `g24_controls` (47), `g24_vocab` (177), `g24_common` (889),
...
- Tool: `tools/effect-map.mjs`. Writes `docs/effect-map.md`. Keys: `g20_tests_mapped` (340).
