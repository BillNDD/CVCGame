...
- Assert measurements and numbers. Never assert a screenshot. Key: `g7_interface_checks` (56).
...
- Baseline floors: `g13_clips` (702) and `g13_engine_tests` (13).
...
- Tool: `tools/effect-map.mjs`. Writes `docs/effect-map.md`. Keys: `g20_tests_mapped` (295).
