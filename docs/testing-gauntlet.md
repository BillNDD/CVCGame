...
- Assert measurements and numbers. Never assert a screenshot. Key: `g7_interface_checks` (60).
...
- Tool: `tools/effect-map.mjs`. Writes `docs/effect-map.md`. Keys: `g20_tests_mapped` (444).
