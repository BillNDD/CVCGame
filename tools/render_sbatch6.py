...
batch = json.loads((OUT.parent / "sbatch6-render.json").read_text(encoding="utf-8"))
...
(OUT / "sbatch6-audio.json").write_text(json.dumps(out), encoding="utf-8")
print("wrote sbatch6-audio.json; %d takes" % len(out), flush=True)
