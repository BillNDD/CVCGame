...
const EXPORTS = ["LEVELS","TRICKY","DIGRAPHS","HEART","INTERVALS","SESSION_SIZE","PROMPT_CAP",
  ...
  "SEAM_MS","SOUNDOUT_SEAM_MS","SOUNDOUT_POP_MS","TILE_SOUND","WORD_SOUND","SOUND_TEXT","soundIdFor","soundIdsFor","bankWords","soundInventory","VOICE_SENTENCES","SENTENCES","SENTENCE_EVERY","sessionSentences","REVEAL_LINES","REVEAL_LINE_TEXT","sentenceWords","revealWord","voiceScript","clipPlan","sentencePlan","sentenceClosePlan","tileSlots","isSeam","seamMs","resolvePack","TTS_UNSAFE_PRAISE","ttsSafePraise"];
