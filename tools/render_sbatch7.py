...
batch = json.loads((OUT.parent / "sbatch7-render.json").read_text(encoding="utf-8"))
...
(OUT / "sbatch7-audio.json").write_text(json.dumps(out), encoding="utf-8")
print("wrote sbatch7-audio.json; %d takes" % len(out), flush=True)
