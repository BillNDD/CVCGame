...
PAL = {
    ...
    # THE YEAR'S FOUR, owner-ruled 2026-09-03 and declared in C as gardenStraw,
    # gardenHusk, gardenOvercast and gardenFrost. They are DIGITS, and that is a
    # rule rather than an accident: letters are the year-round palette, digits
    # are the colours that are not the meadow's own - which 1, 2 and 3, the
    # crocus's cool blues, already were.
    #
    # They had to be digits. All four artists drawing the seasons were briefed
    # with `a k o f` for these, and all four independently found that PAL
    # already binds every one of those letters - they are the RABBIT's fur, its
    # lit side, its dark, its far and body tones. Pasting the season maps as
    # briefed would have silently repainted every rabbit in the garden. Four
...
def _neighbours(pal):
    ...
    # DIGITS ARE INCLUDED, since 2026-09-03. They were skipped while the only
    # digits were the crocus's three cool blues, which are one closed ramp with
    # nothing outside it to step to. The year's four colours are digits now -
    # straw, husk, overcast and frost - and they are ordinary inks that belong
    # in ordinary ramps. Skipping them would have left every dry-season sprite
    # unable to vary at all, which is the one thing this table exists to give.
    inks = sorted(c for c, v in pal.items() if v and c != ".")
    out = {}
    for c in inks:
...
# ============================================================ the year's own
# FORTY-EIGHT SPRITES THAT BELONG TO ONE SEASON ONLY, drawn by four artists on
# 2026-09-03 and judged by the owner one at a time: 44 of 49 approved on the
# first showing, five sent back, four of those approved on the second. They use
# the year's four colours, which are the DIGITS 4 5 6 7 - see the note in PAL
# for why they could not be letters.
#
# Every one was run through the repeat gate BEFORE it landed here, and ten of
# the forty-eight carried a block of pixels twice - including apple_bough, which
# the owner predicted from memory before he had seen any output: "The individual
# repeating parts of each. Like two apples on a branch." All ten were cleared by
# unrepeat(), 119 pixels moved in total, no silhouette touched. The seed sits
# beside each map that needed one.
#
# mushroom_ring is NOT here. It is the one sprite of the batch still open: the
# owner rejected it twice, the second time for "repeated patterns", and the
# version grown rather than stamped is waiting on his eye.
SEASONAL = {
    "bud_break": {  # spring, front, 11 x 18, states 0,1,2,10. Front layer at mid height, set against the bare-twig trees (garry-winter, the leaner, the filbert) so the twig reads as one of theirs - the second...
        "layer": "front", "season": "spring",
        "map": [
            "....t.t....",
            "...tgtg....",
            "...tggg....",
    ...
    "camas_bud": {  # spring, back, 9 x 18, states 0,1,2,10. Back layer standing in the mat exactly where the core camas stands, and always PAIRED with it - buds behind, open spikes in front, which is how a...
        "layer": "back", "season": "spring",
        "map": [
            "....cw...",
            "...vccw..",
            "...vccw..",
    ...
    "catkin_dangle": {  # spring, front, 14 x 16, states 0,1,2,10. Front layer, hung off a bare limb of the filbert or the red alder in the upper third of a panel with open ground behind it so the tails are seen -...
        "layer": "front", "season": "spring",
        "map": [
            ".hbhhhbhhbhhh.",
            ".dbdbbdbbdbbd.",
    ...
    "fiddlehead": {  # spring, mid, 11 x 17, states 0,1,2,10. Ground zone, mid layer: at the foot of a side panel among the swordfern crowns and the moss carpet, its stalk base standing ON a carpet course - the...
        "layer": "mid", "season": "spring",
        "map": [
            "...sgggg...",
            "..sg...sg..",
            ".vg.....sg.",
    ...
    "frogspawn": {  # spring, back, 17 x 8, states 0,1,2,10. Back layer, laid INSIDE the core puddle sprite on its water rows - a raft of jelly with a dark embryo in every egg, deliberately off-square at both...
        "layer": "back", "season": "spring",
        "map": [
            "....cw.cw........",
            "...cddcddw.......",
    ...
    "nest_eggs": {  # spring, front, 16 x 13, states 0,1,2,10. Front layer, seated in a fork of the salal or the huckleberry at mid height and NEVER on the ground - three pale eggs in a woven cup, drawn in...
        "layer": "front", "season": "spring",
        "map": [
            "..bhbbhbhbbhbb..",
            ".b.cw......cw.b.",
    ...
    "oak_new_leaves": {  # spring, mid, 18 x 14, states 0,1,2,10. Mid layer at the tips of a Garry oak's lower limbs, or standing alone in the upper half of a side panel - three lobed leaves in gardenBark and...
        "layer": "mid", "season": "spring",
        "unrepeat": 4,  # 4 px varied to break a 19-pixel copy of itself,
        "map": [
            "........bhh.......",
            ".......dbhhh......",
            "......dbbhhhh.....",
    ...
    "sallow_catkins": {  # spring, back, 13 x 19, states 0,1,2,10. Mid/back layer on the wet-looking ground beside the sedge_clump, stream_edge and puddle - four silver catkins on a red-brown twig, and the easiest...
        "layer": "back", "season": "spring",
        "map": [
            ".....nww.....",
            "....nnnww....",
    ...
    "robin_worm": {  # spring, front, 18 x 15, states 0,1,2,10. Front layer, ground zone: on the open mat or the path edge in the lowest third of a panel, its feet on the ground line - the worm hangs from the beak...
        "layer": "front", "season": "spring",
        "map": [
            "......vvvn........",
            ".....vvvvvn.......",
    ...
    "shoot_through_litter": {  # spring, back, 15 x 12, states 0,1,2,10. Back/mid layer on bare ground low in a panel, beside bark_litter and the nurse_log where the mat courses leave a gap - this is the GROWTH sprite the...
        "layer": "back", "season": "spring",
        "map": [
            ".........sggg..",
            "..ssgg.ssssggg.",
    ...
    "tadpole": {  # spring, front, 12 x 7, states 0,1,2,10. Front layer in the puddle's water or the stream_edge's water band, two or three at different angles - the cheapest sprite in the set and the one a...
        "layer": "front", "season": "spring",
        "map": [
            "..dvvn......",
            ".dvvvvn.....",
    ...
    "blackberry_cane": {  # dry, front, 26 x 15, states 3,4,5. Front layer, arching over other sprites the way `bramble_arch` does and never beside it. One cane carrying all three ripenesses at once, which is...
        "layer": "front", "season": "dry",
        "unrepeat": 1,  # 7 px varied to break a 22-pixel copy of itself,
        "map": [
            "...................tg.t...",
            ".......tg.t.......sgggtg..",
            "......gggsgg.....sggggggt.",
            ...
            "...sgsg.s..pypy.5..vcvc...",
            "...vsvs...ymymym...dvdv...",
            "..sgsgsg..pypypy..vcvcvc..",
            "..vsvsvs...ymym...dvdvdvb.",
            ".bdsgsg....pypy....vcvc.b.",
            "bd.vsvs.....py.....dvdv.db",
            "d...vs..............dv...d",
        ]},
    "cracked_earth": {  # dry, back, 24 x 12, states 4,5. Back layer, TILES HORIZONTALLY at a 24 px pitch — the crack network crosses the x=23/x=0 seam so a long run has no join to find. Lay it where...
        "layer": "back", "season": "dry",
        "unrepeat": 25,  # 14 px varied to break a 21-pixel copy of itself,
        "map": [
            "444544444444444544444444",
            "4444544444444455444r4444",
            "44554554444455d4554r4444",
            "5544445554554454nd55d555",
            "444445444554n5n4454n5444",
            "444rr54445n55d444n545444",
            "44rrra54n54445444454n544",
            "44r444n55444454444n5d544",
            "54r44b45d555445455545n55",
            "45r45k544n4455d544445444",
            "4455b4444444n44444444544",
            "444544444444444444444544",
        ]},
    "dust_path": {  # dry, back, 26 x 9, states 3,4,5. Back layer, TILES HORIZONTALLY at a 26 px pitch with one worn track running through the seam at the same row on both edges. A pale dust film over the...
        "layer": "back", "season": "dry",
        "map": [
            "444444nn444444444nnn444444",
            "nn444nnnnnn4nw4nnnnnn44nnn",
            "nnnnnwnnnnnn54nnnnnnnwnnnn",
            "nnn4nwnnnnnnnn555555nwnnnn",
            "555554nnnn5555555nn554n555",
            "nnnn555nw5nnnnnnn555555nnw",
            "nnnnnnn54555nnnnnwnnnnnn54",
            "n44445555nnnn444nwnnnn44nn",
            "444444444nnn44455444nn4444",
        ]},
    "grasshopper": {  # dry, front, 17 x 12, states 3,4,5. Front layer, ground-to-knee zone: on the dust path, on a warm stone, or among the seed grass, always facing right into the light. The read is the Z —...
        "layer": "front", "season": "dry",
        "map": [
            ".................",
            "....54m..........",
    ...
    "hay_wisp": {  # dry, mid, 19 x 11, states 3,4. Mid layer, sitting ON the ground line at the foot of a side panel or in a phone's bottom corner, where the nurse stump and the cut stump sit. A small...
        "layer": "mid", "season": "dry",
        "map": [
            "...........4h......",
            "........4hm........",
            ".......44hhm.......",
    ...
    "lizard_basking": {  # dry, front, 22 x 8, states 3,4,5. Front layer, and it must be standing ON something: the lit crown of rock_boulder, rock_cobble or the moss rock, mid to low height. A side view,...
        "layer": "front", "season": "dry",
        "map": [
            ".........hhhhhh.......",
            ".......bbbbbbbbb.bhh..",
    ...
    "seed_grass": {  # dry, front, 14 x 20, states 3,4,5. Front layer, standing where grass_tall stands and taller than it: a bunchgrass gone over to seed, three heads at three heights on five stems. It is...
        "layer": "front", "season": "dry",
        "map": [
            "......54m.....",
            "......54m.....",
    ...
    "shrinking_puddle": {  # dry, back, 22 x 9, states 4,5. Back layer, the same place the approved `puddle` goes and never in the same frame as it: this is that pool in August. Its water is the same...
        "layer": "back", "season": "dry",
        "map": [
            "....44444444444444....",
            "..444555555555555444..",
            ".4455555ccccc55555444.",
            "445555ccwwcccn55555544",
            "45555ccccwcccnn5555554",
            "455555ccccccc555555444",
            ".4455555555555555544..",
            "...5545555545555455...",
            ".....5555555555.......",
        ]},
    "snail_shell": {  # dry, front, 11 x 10, states 3,4,5. Front layer, lying in the ground zone — on the dust path, at the foot of a stone, among the bark litter. An empty shell the sun has bleached, so it...
        "layer": "front", "season": "dry",
        "map": [
            "....www....",
            "..nnwnwww..",
    ...
    "swallowtail": {  # dry, front, 19 x 14, states 3,4. Front layer, open air above the flower band and below the canopy, over a gap in the vegetation — where `butterfly_fly` goes, but ONE PER SCREEN and...
        "layer": "front", "season": "dry",
        "unrepeat": 27,  # 8 px varied to break a 18-pixel copy of itself,
        "map": [
            ".......55.55.......",
            "..5hhh...5...mmm5..",
            ".5hhhhh..5..mmmmm5.",
    ...
    "thistledown": {  # dry, front, 11 x 10, states 5. Front layer, in open air low down and within three pixels of the seed grass or the hay — on its own in the middle of nothing it is a fleck, and it is...
        "layer": "front", "season": "dry",
        "map": [
            ".....w.....",
            ".n.n.w.w.w.",
    ...
    "acorn_cluster": {  # fall, mid, 15 x 9, states 6, 7. Mid layer, hung from the lower edge of a garry-mature or garry-veteran crown, or on its own low in a panel where a small warm mark is wanted. The cup...
        "layer": "mid", "season": "fall",
        "unrepeat": 1,  # 4 px varied to break a 18-pixel copy of itself,
        "map": [
            "......5bbbbbhh.",
            "..5bbbh...555b.",
            "..5555b..5555b.",
    ...
    "apple_bough": {  # fall, back, 22 x 11, states 6, 7. Back or mid layer, hung across the upper third of a side panel or reaching in over a phone's top band, so the fruit hangs into air rather than into...
        "layer": "back", "season": "fall",
        "unrepeat": 1,  # 1 px varied to break a 18-pixel copy of itself,
        "map": [
            "hhbb.sgt......gt......",
            "bbbbhbbbhbbh.sg.....gt",
            "555555555555bhbb...sgg",
            ".....h.....g5555bbbbbh",
            ".yyy.54hh..sg.....h...",
            "pyyyyyhhmh.vs.yyy.5hh.",
            "pyyyyy4hhhh..pypyy4hmh",
            "pyyyyyy4hh4..pyyyy4hhh",
            "ppyyyyyyyy...pyyyyy44.",
            ".ppyyyyyy.....pyyyyyy.",
            "..pppyyy........pyyy..",
        ]},
    "goose_skein": {  # fall, front, 25 x 5, states 7, 8. Front layer, sky zone only - the top sixth of a tall panel or the phone's top band, above every canopy and above bird_far if both are used. Five...
    ...
    "leaf_pile": {  # fall, mid, 24 x 8, states 8. Mid layer on the ground line, late fall only - it is the state-8 mark, the thing a child recognises as the end of the year's leaves. The mound peaks...
        ...
        "map": [
            ...
            "......bbhhbhhhbhm.......",
            "...bhh5bhhbhhhbhhbhm....",
            ".5bhhb5hhbhh5bhhhbhhbhm.",
            "55bh55bhh55bhh55bhh55bhm",
            "55b555b555bh555b555b555b",
        ]},
    "oak_bough_turning": {  # fall, mid, 17 x 16, states 6, 7. Mid layer at the top of a side panel, or reaching in from a phone's top corner, so the leaves hang into air. Both hanging leaves are drawn to the...
        "layer": "mid", "season": "fall",
        "map": [
            "............sgg..",
            "...........vssgg.",
    ...
    "oak_leaf_falling": {  # fall, front, 9 x 6, states 7, 8. Front layer, in open air - a gap between the canopy and the flower band, tilted the way it is drawn so it reads as falling and not as lying down....
        "layer": "front", "season": "fall",
        "map": [
            "....bhm..",
            "..bbhhhm.",
    ...
    "pumpkin_vine": {  # fall, mid, 18 x 18, states 6, 7. Mid layer, lying on the ground beside the mat where the vine has room to sprawl left; the uncarved twin of the lantern, so the two tell a story if...
        "layer": "mid", "season": "fall",
        "map": [
            "..st.stt..........",
            ".vssssstt.........",
    ...
    "rose_hips": {  # fall, mid, 15 x 14, states 6, 7, 8. Mid layer, standing in the flower band where the the warm months blooms have gone - the wild rose's fall mark. The cane steps right as it climbs and...
        "layer": "mid", "season": "fall",
        "map": [
            "..........sssg.",
            ".........vs.py.",
    ...
    "spider_web": {  # fall, front, 16 x 16, states 6, 7. Front layer, slung under a twig in the upper half of a panel with nothing behind it - the dark ground IS what the web is seen against, so it must not...
        "layer": "front", "season": "fall",
        "map": [
            "55bbbbbbhhhhhhhh",
            ".c.......6.6....",
    ...
    "squirrel_nut": {  # fall, front, 14 x 13, states 6, 7, 8. Front layer, trunk or stone zone - on a boulder, an arbutus limb or the ground beside the nurse stump, mid to low height. Deliberately mirrored from...
        "layer": "front", "season": "fall",
        "map": [
            "..........bhh.",
            ".........bbhhh",
    ...
    "windfall_apples": {  # fall, front, 16 x 10, states 7, 8. Front layer, on the ground line directly under an apple_bough if one is in the same panel - that pairing is the whole point. One apple stands with...
        "layer": "front", "season": "fall",
        "map": [
            "....5sgt........",
            "...p5y..........",
    ...
    "bulb_in_snow": {  # winter, mid, 14 x 14, states 9, and the edge of 10 — and it is the one sprite that should be the LAST thing added and the last thing removed as the year closes. On the ground line, at the inner edge of the frame where a child's eye leaves the last word: three blades of a bulb pushing up THROUGH a snow mound....
        "layer": "mid", "season": "winter",
        "map": [
            "......gt......",
            "......gt......",
            "....s.gt......",
    ...
    "chickadee": {  # winter, mid, 21 x 13, states 9, and the edge of 10. Perched: its two foot pixels must land on an arbutus limb, a bare conifer limb or the wet_twigs, upper-mid height, the same seat as the wren. A...
        "layer": "mid", "season": "winter",
        "map": [
            ".....dddnn...........",
            "...dddddddn..........",
    ...
    "frosted_seedhead": {  # winter, mid, 10 x 20, states 9, and the edge of 10. Standing out of the mat in the back or mid layer, the same seat as camas, and cheap enough to repeat two or three times at different heights along a...
        "layer": "mid", "season": "winter",
        "unrepeat": 8,  # 6 px varied to break a 21-pixel copy of itself,
        "map": [
            "...77.....",
            "..75457...",
            "...545....",
    ...
    "ilex_sprig": {  # winter, mid, 24 x 21, states 9, and the edge of 10. Mid layer, in front of the dark mass of a conifer or the shaded flank of a rock, where its berries are the only warm thing in the frame — one per...
        "layer": "mid", "season": "winter",
        "unrepeat": 15,  # 52 px varied to break a 56-pixel copy of itself,
        "map": [
            "...t...t................",
            ".ttsssssst......t...t...",
            ".tsssssssstsb.tsssssstt.",
            "tssssssssssvbtsssssssst.",
            ".tsssssssssvvsssgggsssst",
            "..tsssssssvsvssggssssst.",
            "...vsssssv.sbvsggsssst..",
            "....v...v..sb.vsgggsv...",
            "...........sbs.v...v....",
            "...........sbsym........",
    ...
    "iced_puddle": {  # winter, mid, 22 x 7, states 9, and the edge of 10. Flat on the ground, the same seat as the existing puddle (which it is drawn to replace one-for-one in the winter states): an opaque ice skin in o...
        "layer": "mid", "season": "winter",
        "map": [
            "....55556666665555....",
            ".555ccc7666ccc7776555.",
            "5556666dddc66666666555",
            "556666cdddd666666ccc55",
            "5556cc66ddc66666666555",
            ".5556666666ccc6666555.",
            "....55556666665555....",
        ]},
    "rain_streak": {  # winter, mid, 3 x 7, states 9, and the edge of 10. Rain. One stroke, stamped many times — it is the only sprite here that cannot be one island as a group, so it is authored as a single streak and...
        "layer": "mid", "season": "winter",
        "map": [
            "..7",
            "..6",
    ...
    "snow_bough": {  # winter, mid, 22 x 17, states 9, and the edge of 10. A conifer bough loaded with wet snow, entering from the left of a side panel or across the top-left shade corner at the height of the existing...
        "layer": "mid", "season": "winter",
        "unrepeat": 27,  # 22 px varied to break a 24-pixel copy of itself,
        "map": [
            "..7777....7777........",
            ".6777777.677777.......",
            "c666666666666677......",
            "ccc6666666666677777...",
            ".ccc66666336677776777.",
            "..cccccc33366677766777",
            "dvsddvsdcccc6666666677",
            ".dvssdvssdvsdccc666667",
            "..dvssdvsgdvssdcc6666.",
            "...dvsssjsggdvssdcc66.",
            "....ddvssjsgsdvssdcc..",
            ".......ddvssdvssdvsd..",
    ...
    "snow_tracks": {  # winter, mid, 30 x 14, states 9, and the edge of 10. The ground line at the foot of a side panel or across a phone's bottom band: a stone capped with snow, and two cloven deer prints marching away...
        "layer": "mid", "season": "winter",
        "map": [
            "......77......................",
            ".....77776....................",
            ...
            ".555nnnnnnnnnnn...............",
            ".5555nnnnnnnnnn...............",
            ".55555nnnnnnnn5........7777777",
            ".5555555nnnn555.77777777cc7cc7",
            "76666666666666667cc7cc77cc7cc7",
            "66666666666666666cc6cc666ccc66",
            "666666666666666666ccc666666666",
            "cccccccccccccccccccccccccccccc",
        ]},
    "spent_mushroom": {  # winter, mid, 14 x 14, states 9, and the edge of 10. The forest floor proper — the bottom 30 px of a side panel and the two bottom corners, the same seat as mushroom_cluster and red_mushroom, and never...
        "layer": "mid", "season": "winter",
        "map": [
            ".....4444.....",
            "...45555444...",
    ...
    "wet_twigs": {  # winter, mid, 16 x 20, states 9, and the edge of 10. The mid layer at the front of a side panel or in a bottom corner, in front of a conifer where its gaps show something behind: a bare shrub of wet...
        "layer": "mid", "season": "winter",
        "map": [
            "...6.........6..",
            "...d........dc..",
    ...
    "egg_chevron": {  # egg, back, 7 x 8, states 0, 1, 2, 10. Hidden in a spring state, 35-60% covered with its foot buried, never more than two in a frame.
        "layer": "back", "season": "egg",
        "map": [
            "...88...",
            "..8888..",
            ".899988.",
    ...
    "egg_meridian": {  # egg, back, 8 x 9, states 0, 1, 2, 10. Hidden in a spring state, 35-60% covered with its foot buried, never more than two in a frame.
        "layer": "back", "season": "egg",
        "map": [
            "...88...",
            "..8998..",
    ...
    "egg_plain": {  # egg, back, 5 x 7, states 0, 1, 2, 10. Hidden in a spring state, 35-60% covered with its foot buried, never more than two in a frame.
        "layer": "back", "season": "egg",
        "map": [
            ".ccw.",
            "cccww",
    ...
    "egg_spotted": {  # egg, back, 5 x 6, states 0, 1, 2, 10. Hidden in a spring state, 35-60% covered with its foot buried, never more than two in a frame.
        "layer": "back", "season": "egg",
        "map": [
            "..888..",
            ".88998.",
...
SPRITES = {
    ...
    "stream_edge": {  # back, 18 x 20: TILES VERTICALLY, 20 px pitch, top to bottom. Water, then the wet line, then the sand margin, then the bank's gravel. The margin is what the owner asked for - "a small amount of sand bordering and blending two parts" - so its width changes row by row, grains are carried out into the water and water lies in the sand, and no edge in it is a straight seam between two materials
        "layer": "back", "unrepeat": 12,  # 2026-09-03: 7 px varied to break a 20-pixel copy of itself. It could not be fixed at all until the year's four colours landed the same evening - the cool petal had no lighter neighbour, and gardenOvercast is it.
        "map": [
            "cccccvkoooffffffff",
            "cwwwcvkonnofffonnf",
            "cccccockonnfffooof",
