...
batch = json.loads((OUT.parent / "sbatch2-render.json").read_text(encoding="utf-8"))
...
(OUT / "sbatch2-audio.json").write_text(json.dumps(out), encoding="utf-8")
print("wrote sbatch2-audio.json; %d takes" % len(out), flush=True)
